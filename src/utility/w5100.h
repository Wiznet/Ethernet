...
public:
  ...
  __GP_REGISTER8 (SYCR0, 0x0000, 0x2004);

  // System Status Register
  __GP_REGISTER8 (SYSR_W6100, 0x0000, 0x2000);

  // LOCK Register

  // Network Lock Register
  __GP_REGISTER8 (NETLCKR_W6100, 0x0000, 0x41F5);

  // Chip Lock Register
  __GP_REGISTER8 (CHPLCKR_W6100, 0x0000, 0x41F4);

  // PHY Lock Register
  __GP_REGISTER8 (PHYLCKR_W6100, 0x0000, 0x41F6);

  // PHY Status
  __GP_REGISTER8 (PHYCFGR_W6100, 0x0000, 0x3000);

  // Chip Version Register
  __GP_REGISTER8 (VERSIONR_W6100, 0x0000, 0x0000);

  // Chip Version Register
  __GP_REGISTER8 (CVERSIONR_W6100, 0x0000, 0x0002);
